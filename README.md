...
# Requirements
1. [REFramework](https://www.nexusmods.com/residentevilvillage/mods/60) (v1.460+);
...
2. (Optionally) Install [REFramework Direct2D](https://nexusmods.com/residentevilvillage/mods/400);
3. Download the mod:
    * Official release can be downloaded from [Nexus Mods](https://nexusmods.com/residentevil42023/mods/84);
